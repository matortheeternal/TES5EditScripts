...
var
  ...
  gender, template, kwadd, fadd, name, hair, brow, eyes, scar, fhair: string;
  ...
  female, variableheight, done: boolean;
...
begin
  ...
  AddMessage('Don''t forget to generate NPC FacegenData in the CK with Ctrl+Alt+F4!');
  AddMessage(#13#10#13#10);
end;
