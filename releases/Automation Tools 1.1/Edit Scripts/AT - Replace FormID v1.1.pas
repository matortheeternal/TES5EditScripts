...
var
  ...
  slMainFiles, slMasters, slFormIDs: TStringList;
...
begin  
  ...
  AddMessage('----------------------------------------------------------');
  AddMessage('Replace FormID v1.1: Finds and replaces FormIDs.');
  AddMessage('----------------------------------------------------------');
  ...
  slMainFiles := TStringList.Create;
  slMainFiles.Add('Skyrim.esm');
  slMainFiles.Add('Update.esm');
  slMainFiles.Add('Dawnguard.esm');
  slMainFiles.Add('HearthFires.esm');
  slMainFiles.Add('Dragonborn.esm');
  slMainFiles.Add('Skyrim.Hardcoded.keep.this.with.the.exe.and.otherwise.ignore.it.I.really.mean.it.dat');
  // stringlists created
...
begin
  ...
  if slMainFiles.IndexOf(GetFileName(GetFile(e))) > -1 then begin
