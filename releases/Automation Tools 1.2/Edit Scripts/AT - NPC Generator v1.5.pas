...
begin
  ...
  try
    ...
    if frm.ShowModal = mrOk then begin
      ...
      gender := Lowercase(cb02.Text);
      if not SameText(cb03.Text, 'Random') then race := slRaces.Objects[cb03.ItemIndex - 1];
...
begin
  ...
  AddMessage('-------------------------------------------------------');
  AddMessage('NPC Generator v1.5: Generates random NPCs.');
  AddMessage('-------------------------------------------------------');
